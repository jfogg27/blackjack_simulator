...
# Setup 
Download the main game python file (Have to have python installed)  and the cvs file as blackjack_strategy.cvs. Edit the cvs file to have your strategy. The top row is what the dealer is showing and the left column is what you're showing. Do not edit these. Now run the python file.
